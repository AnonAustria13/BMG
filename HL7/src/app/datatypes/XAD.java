...
public class XAD extends HL7Type
{
    ...
    public String parseToHL7(String delim) 
    {
        return String.format(
            ...
            HL7Utils.stringify(this.streetAddress), 
            HL7Utils.stringify(this.otherDesignation), 
            HL7Utils.stringify(this.city), 
            HL7Utils.stringify(this.stateOrProvince), 
            HL7Utils.stringify(this.zipOrPostalCode), 
            HL7Utils.stringify(this.country), 
            HL7Utils.stringify(this.addressType), 
            HL7Utils.stringify(this.otherGeographicDesignation), 
            HL7Utils.stringify(this.countyParishCode), 
            HL7Utils.stringify(this.censusTract), 
            HL7Utils.stringify(this.addressRepresentationCode), 
            HL7Utils.stringify(this.addressValidityRange), 
